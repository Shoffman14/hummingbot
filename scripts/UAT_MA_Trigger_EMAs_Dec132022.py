...
session_auth = usdt_perpetual.HTTP(
    ...
    api_key='2c6U1dfTMcts15Woo0', # [11/24/22]: New API created today
    api_secret='wo10mXkNiPa3QFBG8QNpyFiF92gRrxUza81x'
)
...
class EMATriggers(ScriptStrategyBase):
    ...
    def on_tick(self):
        ...
        ema_current = (p*self.multiplier) + (slow_ma*(1-self.multiplier))
